...
export type ConsoleLogListener = (line: string) => void;

let listeners: ConsoleLogListener[] = [];

export function listen(listener: ConsoleLogListener): () => void {
...
import { ReceiveFromWorker } from "./worker/worker-types";
